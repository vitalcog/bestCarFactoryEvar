...
class Factory {
  constructor(make, location, warranty) {
    this.make = make;
    this.model = 'generic';
    this.color = 'generic';
  ...
  massBuild(quantity) {
    console.log('Building ' + quantity+ ' ' + this.color + ' ' + this.model + '\'s');
  }
...
class MazdaFactory extends Factory {
  constructor() {
    super('Mazda', 'U.S.A', '60,000 miles / 3 years');
  }
}
...
// It should extend from MazdaFactory.
...
class Car extends MazdaFactory {
...
// Write your code below:
class Truck extends MazdaFactory {
  constructor(model, doors, color, enginetype, trans) {
    super();
    this.model = model;
    this.doors = doors;
    ...
    this.package = ['trailer hitch', {standard: {backupCamera: true}}, 'audio (basic)'];
  }
}
...
let mazda3 = new Car('mazda3', '4', 'red', 'hybrid', 'auto');
...
// Write your code below:
let miataRf = new Sport('miataRf', 'red');
miataRf.warranty = 'Extended';
...
// Write your code below:
miataRf.customerBuild('black', ['concealed headlights', 'fantastic suspension upgrade', 'sexy leather interior', 'adaptive cruise control']);
...
// Write your code below:
let trailBlazer = new Truck('trail blazer', '2', 'blue', 'petrol', 'manual');
...
// Write your code below:
trailBlazer.customerBuild('red', ['butt toaster', ' tinted windows', ' fog lights', ' rocket boosters']);
